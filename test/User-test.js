...
describe('User', function() {
  ...
  beforeEach(() => {
    chai.spy.on(domUpdates, "displayAverageHourlySleepThisWeek", () => {});
    chai.spy.on(domUpdates, "displayAverageSleepQualityThisWeek", () => {});
    chai.spy.on(domUpdates, "displayAverageMinutesActiveThisWeek", () => {});
  ...
  it('calculateAverageHoursThisWeek should calculate average sleep hours for week before given date', function() {
    ...
    expect(domUpdates.displayAverageHourlySleepThisWeek).to.have.been.called(1);
    expect(domUpdates.displayAverageHourlySleepThisWeek).to.have.been.called.with('7.9');
  });
  it('calculateAverageQualityThisWeek should calculate average quality of sleep for week before a given date', function() {
    ...
    expect(domUpdates.displayAverageSleepQualityThisWeek).to.have.been.called(1);
    expect(domUpdates.displayAverageSleepQualityThisWeek).to.have.been.called.with('8.5');
  });
  ...
  it('calculateAverageMinutesActiveThisWeek should calculate the average minutes active', function() {
    ...
    expect(domUpdates.displayAverageMinutesActiveThisWeek).to.have.been.called(1);
    expect(domUpdates.displayAverageMinutesActiveThisWeek).to.have.been.called.with('39');
  });
  ...
  it('calculateAverageFlightsThisWeek should calculate the average flights of stairs taken in a given week', function() {
    ...
    expect(domUpdates.displayAverageFlightsThisWeek).to.have.been.called.with('8.4');
  });
